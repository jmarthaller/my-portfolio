export const experience = [
  ...
  },
  {
    ...
    desc: "Refactored multiple components in TypeScript | Leveraged GraphQL to describe and fetch data throughout application | Enhanced mobile web experience by making several pages mobile-responsive | Conducted market research with potential users",
  },
  {
  ...
  },
  {
    ...
    year: "2012-2013",
    companyLink: "",
    desc: "Launched a video production company and oversaw operations for over two dozen clients | Implemented accounting procedures that resulted in a budget surplus | Supervised and trained 5 person team of apprentice editors",
  },
];
